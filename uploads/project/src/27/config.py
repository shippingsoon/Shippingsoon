...
FORTUNES = [
	...
	"We are here on the planet only once, and might as well gtet a feel for the place.",
...
QUOTES = [
	"It's easier to fight for one's principles than to live up to them.",
	"Saying a place on the internet is sfw is like having one of those \"X days without an accident\" signs.",
