...
function js_asset($asset_name, $module_name = NULL, $defer = FALSE)
{
	return '<script type="text/javascript" src="'.js_asset_url($asset_name, $module_name).'"'.(($defer) ? ' defer' : '').'></script>'."\n";
}
